...
struct HelpUsViewModel {
    ...
    private let sharingText: [String] = [
        ...
        NSLocalizedString(
            ...
            value: "Check out Trust - the wallet that lets me securely store my Moac and ERC20 tokens.",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text3",
            value: "I securely store Moac and ERC20 tokens in the Trust wallet",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text4",
            value: "I secure my Moac and ERC20 tokens in the Trust wallet.",
            comment: ""
        ),
    ]
