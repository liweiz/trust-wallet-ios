...
//
//                        let signature = Crypto.sign(hash: hash, privateKey: keystoreJSONStr.data(using: .utf8)!)
...
//                    account: Account(wallet: .none, address: MoacAddress(string: addrOfBalanceCheck)!, derivationPath: DerivationPath(purpose: 0, coinType: 0)),
